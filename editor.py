...
config.EDITOR_RENDER_SCALE = 2.0
class Editor:
    def __init__(self):
        pygame.init()
        ...
        self.assets = {
            ...
            # ← сюда добавляем новые «гейз-объекты»
            #'GazePlatform': images_load('functional_blocks/GazePlatform'),
            #'GazeDoor':     images_load('functional_blocks/GazeDoor'),
            #'GazeLight':    images_load('functional_blocks/GazeLight'),
        }

        self.level = "map2.json"
        ...
        self.tilemap.eload("data/Maps/map2.json")
    ...
    def run(self):
        ...
        while True:
            ...
            mouse_pos = (mouse_pos[0]/ config.EDITOR_RENDER_SCALE, mouse_pos[1]/config.EDITOR_RENDER_SCALE)
                ...
                match event.type:
                    ...
                    case pygame.KEYDOWN:
                        ...
                        match event.key:
                            ...
                            case pygame.K_a:
                                self.movement[0] = config.SCROLL_SPEED

                            case pygame.K_d:
                                self.movement[1] = config.SCROLL_SPEED

                            case pygame.K_w:
                                self.movement[2] = config.SCROLL_SPEED

                            case pygame.K_s:
                                self.movement[3] = config.SCROLL_SPEED
                            case pygame.K_o:
